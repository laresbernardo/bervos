...
const SAMPLE_STORIES: SampleStory[] = [
  ...
  },
  {
    ...
    bodyEN: [
      ...
      'The old man rocked his wicker chair before turning. Cicadas drowned out the wind in the grass. He gestured toward a wooden stool without a word. Carmen brought the enamel coffee pot and two tin cups; she didn’t meet my eyes, but as she set the cup down, the hem of her skirt brushed my arm and that scent of fresh pine restored my voice. The old man waited for the *guayoyo* coffee steam to settle before looking up. My whole speech crumbled in my throat. I told him straight that I worked Monday to Monday, that land didn’t die in my hands, and that I wanted to ask for his daughter’s hand in marriage properly. Don Ruperto didn’t blink. He took a long sip, looked toward the pasture, blew on the hot steam, stood up slowly, and told me to be ready tomorrow at five to mend the boundary fence.'
    ]
  },
  {
    id: 'finlandia',
