...
export const InitiativeCard: React.FC<InitiativeCardProps> = ({ item, onUsersClick, onRefresh, isRefreshing, onShowBacklog, isLoadingData }) => {
  ...
  return (
    ...
    >
      <div>
        <div className="flex justify-between items-start mb-6">
          ...
          <div className="flex flex-col items-end gap-2 shrink-0">
            {!isOS && (
              isLoadingData && item.uptime === undefined ? (
                <div className="w-16 h-5 bg-white/5 border border-white/5 rounded-lg animate-pulse" />
            ...
            <div className="flex items-center gap-1.5">
              {onShowBacklog && (
                isLoadingData && item.backlogCount === undefined ? (
                  <div className="w-7 h-7 bg-white/5 border border-white/5 rounded-lg animate-pulse" />
                ) : (
                  <button
                    onClick={(e) => {
                      e.stopPropagation();
      ...
      <div>
            ...
            <>
              <div className="space-y-1">
                ...
                <div className="flex items-center gap-1.5 text-white">
                  ...
                  {isLoadingData && item.stars === undefined ? (
                    <div className="w-12 h-5 bg-white/5 border border-white/5 rounded-md animate-pulse mt-1" />
                  ) : (
              ...
              <div className="space-y-1">
                ...
                <div className="flex items-center gap-1.5 text-white">
                  ...
                  {isLoadingData && item.openIssues === undefined ? (
                    <div className="w-12 h-5 bg-white/5 border border-white/5 rounded-md animate-pulse mt-1" />
                  ) : (
          ...
          {isWebApp && (
            <>
              <button
                ...
                disabled={!onUsersClick || isLoadingData}
                type="button"
                className={`space-y-1 text-left ${onUsersClick && !isLoadingData ? 'cursor-pointer group/btn select-none hover:opacity-85 transition-opacity' : 'opacity-80'}`}
              >
                ...
                <div className="flex items-center gap-1.5 text-white">
                  ...
                  {isLoadingData && item.totalUsers === undefined ? (
                    <div className="w-12 h-5 bg-white/5 border border-white/5 rounded-md animate-pulse mt-1" />
                  ) : (
              ...
              <div className="space-y-1">
                ...
                <div className="flex items-center gap-1.5 text-white">
                  ...
                  {isLoadingData && item.active30d === undefined ? (
                    <div className="w-12 h-5 bg-white/5 border border-white/5 rounded-md animate-pulse mt-1" />
                  ) : (
            ...
            <>
              <div className="space-y-1">
                ...
                <div className="flex items-center gap-1.5 text-white">
                  ...
                  {isLoadingData && item.downloads === undefined ? (
                    <div className="w-12 h-5 bg-white/5 border border-white/5 rounded-md animate-pulse mt-1" />
                  ) : (
              ...
              <div className="space-y-1">
                ...
                <div className="flex items-center gap-1.5 text-white">
                  ...
                  {isLoadingData && item.latency === undefined ? (
                    <div className="w-12 h-5 bg-white/5 border border-white/5 rounded-md animate-pulse mt-1" />
                  ) : (
        ...
        {isOS && (
          isLoadingData && !item.lastUpdated ? (
            <div className="w-36 h-4 bg-white/5 border border-white/5 rounded-md animate-pulse mb-4" />
          ) : item.lastUpdated ? (
        ...
        {isLoadingData && !item.commits ? (
          <div className="mt-4 pt-4 border-t border-white/5 space-y-2 mb-4">
            <span className="mono-label !text-slate-600 block mb-1.5 text-[9px] animate-pulse">LOADING_COMMIT_HISTORY...</span>
            <div className="space-y-3">
              ...
              <div className="flex gap-2 items-center">
                <div className="w-10 h-3 bg-white/5 rounded animate-pulse" />
                <div className="w-16 h-3 bg-white/5 rounded animate-pulse" />
                <div className="w-36 h-3 bg-white/5 rounded animate-pulse" />
              </div>
            </div>
          </div>
